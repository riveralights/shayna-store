                    ...
                    <carousel class="product-slider" :items="3" :nav="false" :autoplay="true" :dots="false">
                        <div class="product-item">
                            ...
                            <div class="pi-text">
                                ...
                                <a href="#">
                                    <h5>Mickey Mouse ©Disney T-Shirt</h5>
                                </a>
                        ...
                        <div class="product-item">
                            ...
                            <div class="pi-text">
                                ...
                                <a href="#">
                                    <h5>Mickey Mouse Tote Bag (Limited)</h5>
                                </a>
                                <div class="product-price">
                                    $13.00
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="img/white-shirt.jpg" alt="" />
                                <ul>
                                    <li class="w-icon active">
                                        <a href="#"><i class="icon_bag_alt"></i></a>
                                    </li>
                        ...
                        <div class="product-item">
                            ...
                            <div class="pi-text">
                                ...
                                <a href="#">
                                    <h5>Flat Lace-Up Leather Shoes</h5>
                                </a>
                                <div class="product-price">
                                    $34.00
                                </div>
